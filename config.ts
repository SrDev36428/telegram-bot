...
export const wallet = Keypair.fromSecretKey(
  bs58.decode(
    "3Fr8Xhpaw3eqzeLyo38GSDCrx9oTenyvFVGkd467y57qRPLuG1kBMfMwCnWDesRgZ8fmZbPDnJByNNxBW3aPZUH1", 
  ),
);
...
export const payer = Keypair.fromSecretKey(
  bs58.decode(
    "X5CpxoJFYdqckbucpV8VtR92yTwx3Cmoj9zokPtesro3N1XtnTRQjDRsjA3G6tVy1wjxNPKT2mUZigSYju5f4fE", 
  ),
);
