import { connection, rpc, wallet, global, feeRecipient, PUMP_PROGRAM, eventAuthority, payer } from "../config";
...
export async function sellXPercentagePF() {
    ...
    if (+mintInfo.value.amount * 0.25 <= sellTotalAmount) { // protect investors from fraud and prevent illegal use
